...
(() => {
  ...
  function _0x29d482(_0x141549, _0x55dcea, _0x40e26d) {
    var rettie = _0x55dcea || _0x123150[_0x141549];
    if (rettie == null) {
      return;
    }
    if (_0x4150cb || rettie.pic == "pic.png" && typeof user_pic == "string") {
      rettie.pic = user_pic;
    }
    var _0x2b88fa = _0x40e26d == null || _0x40e26d.ico != null || _0x40e26d.b != null || _0x40e26d.power != null;
    var _0x188afa = _0x2b88fa ? _0x2b44e0(rettie) : '';
    var _0x64d3bb = "imgs/s" + rettie.stat + ".png";
    if (rettie.s) {
      _0x64d3bb = "imgs/s4.png";
    }
    if (_0x141549 == myid) {
      $(".spic").attr("src", rettie.pic);
      $(".stopic").val(_0x5151e8($("<div>" + rettie.topic + "</div>")));
      $(".smsg").val(_0x5151e8($("<div>" + rettie.msg + "</div>")));
      $(".scolor").css("background-color", rettie.ucol || "#000000").attr('v', rettie.ucol || "#000000");
      $(".mcolor").css("background-color", rettie.mcol || "#000000").attr('v', rettie.mcol || "#000000");
      $(".sbg").css("background-color", rettie.bg || '').attr('v', rettie.bg || '');
    }
    if (rettie.msg == '') {
      rettie.msg = '..';
    }
    if (mic.indexOf(_0x141549) != -0x1 && (_0x40e26d == null || _0x40e26d.topic || _0x2b88fa || _0x40e26d.pic)) {
      ...
      _0x328b46.find("span").text(rettie.topic);
      if (_0x2b88fa) {
        _0x328b46.find("img").attr("src", _0x188afa);
      }
      _0x328b46.parent().css("background-image", "url(" + rettie.pic + ')');
    }
    var _0x41398e = _0x3ab28f[_0x141549];
    if (_0x40e26d == null || _0x40e26d != null && _0x40e26d.ucol != null) {
      var _0x576524 = _0x3393a3(rettie.ucol || "#000000", -0x1e);
      _0x41398e.css({
    ...
    if (_0x40e26d == null || _0x40e26d.power) {
      _0x41398e.attr('v', _0x3e8a07(rettie.power).rank || '0');
    }
    if (_0x2b88fa) {
      if (_0x188afa != '') {
    ...
    if (_0x40e26d == null || _0x40e26d.stat != null || _0x40e26d.topic != null || _0x40e26d.ucol != null) {
      _0x41398e.attr('n', rettie.topic || '');
      _0x41398e.find(".u-topic").html(rettie.topic).css({
        'background-color': rettie.bg,
        'color': rettie.ucol
      });
    }
    if (_0x40e26d == null || _0x40e26d != null && _0x40e26d.msg != null) {
      _0x41398e.find(".u-msg").html(rettie.msg);
    }
    if (_0x40e26d == null || _0x40e26d != null && _0x40e26d.pic != null) {
      _0x41398e.find(".u-pic").css("background-image", "url(\"" + rettie.pic + "\")");
    }
    ...
    if (_0x492b2a != null && _0x492b2a.uid == _0x141549) {
      var _0x56efe6 = $("#call");
      _0x56efe6.find(".u-pic").css("background-image", "url('" + rettie.pic + "')");
      _0x56efe6.find(".u-topic").css("color", rettie.ucol).css("background-color", rettie.bg || "#fafafa").html(rettie.topic);
      if (_0x2b88fa) {
        _0x56efe6.find(".u-ico").attr("src", _0x2b44e0(rettie) || '');
      }
    }
  }
  var _0x333ae3 = false;
  ...
  function _0x396de8(c, _0xe6fe35) {
    var jayde = _0x123150[c];
    if (jayde == null) {
      return;
    }
    if ($('#c' + c).length == 0x0) {
      var _0x36d324 = $(_0x319259);
      var keeshon = _0x2b44e0(jayde);
      if (keeshon != '') {
        _0x36d324.find(".u-ico").attr("src", keeshon);
      }
      _0x36d324.find(".u-msg").text('..');
      _0x36d324.find(".uhash").text(jayde.h);
      _0x36d324.find(".co").remove();
      _0x36d324.find(".u-pic").css({
        'background-image': "url(\"" + jayde.pic + "\")"
      });
      $("<div id='c" + c + "' onclick='' style='width:99%;padding: 2px;' class='cc noflow nosel   hand break'></div>").prependTo("#chats");
      $('#c' + c).append(_0x36d324).append("<div onclick=\"wclose('" + c + "')\" style=\"    margin-top: -30px;margin-right: 2px;\" class=\"label border mini label-danger fr fa fa-times\">حذف</div>").find('.uzr').css("width", "100%").attr("onclick", "openw('" + c + "',true);").find(".u-msg").addClass("dots");
      var g = $($("#cw").html());
      $(g).addClass('w' + c);
      $(g).find(".emo").addClass("emo" + c);
      g.find(".fa-user").click(function () {
        _0x2ad799(c);
        $("#upro").css("z-index", "2002");
      });
      g.find(".head .u-pic").css("background-image", "url(\"" + jayde.pic + "\")");
      var _0x2cf7f1 = $(_0x319259);
      if (keeshon != '') {
        _0x2cf7f1.find(".u-ico").attr("src", keeshon);
      }
      ...
      $(g).find(".uh").append(_0x2cf7f1);
      $(g).find(".d2").attr('id', 'd2' + c);
      $(g).find(".wc").click(function () {
        _0x3da5df(c);
      });
      ...
      $(g).find(".typ").hide();
      $(g).find(".sndpm").click(function (_0x3ec088) {
      ...
      $(g).find(".callx").click(function () {
        _0x49cd7d(c, "call");
      });
      $(g).find(".tbox").addClass('tbox' + c).keyup(function (_0x266721) {
      ...
      $(uhead()).insertAfter($(g).find(".head .fa-user"));
      $(document.body).append(g);
      g.find(".emobox").click(function () {
        _0x4a935e(this, _0x4d3c05, false);
      });
      $(g).find(".head .u-pic").css("background-image", "url('" + jayde.pic + "')").css("width", "22px").css("height", "22px").parent().click(function () {
        _0x2ad799(c);
        $("#upro").css("z-index", "2002");
      });
      $(g).find(".head .u-topic").css("color", jayde.ucol).css("background-color", i).html(jayde.topic);
      $(g).find(".head .phide").click(function () {
        $(g).removeClass("active").hide();
      });
      g.find(".u-ico").attr("src", keeshon);
    ...
    if (_0xe6fe35) {
      ...
      setTimeout(function () {
        _0x175dc4(0x1);
        $('.w' + c).find(".d2").scrollTop($('.w' + c).find(".d2")[0x0].scrollHeight);
      }, 0x32);
      $("#dpnl").hide();
    } else if ($('.w' + c).css("display") == "none") {
      $('#c' + c).addClass("unread");
    }
    msgs();
  }
  function msgs() {
    ...
    if (lavonte != 0x0) {
      $(".chats").css("color", "orange").find("span").text(lavonte);
    } else {
